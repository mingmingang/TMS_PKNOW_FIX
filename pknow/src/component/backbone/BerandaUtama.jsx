...
const sliderData = [
  ...
  {
    name: "Amadea Dewasanya",
    role: "Product Designer",
    company: "CrescentRating",
    img: sampel2,
  },
  {
    name: "Debby Surya Pradana",
    role: "UI/UX Designer",
    company: "Ekosis",
    img: sampel3,
  },
  {
    name: "Dialus Andari",
    role: "UI/UX Designer",
    company: "Universal Eco Pasific",
    img: sampel4,
  },
  {
    name: "Hutami Septiana Raswaty",
...
const sliderBerita = [
  {
    name: "Program Talenta Digital 2022 Jangkau 200 Ribu",
    role: "Program Talenta Digital 2022 Jangkau 200 Ribu Milenial",
    company: "Detik.Com",
    img: berita1,
  },
  {
    name: "Infografis Terima Kasih Coach Shin Tae-yong",
    role: "Infografis Terima Kasih Coach Shin Tae-yong",
    company: "News.com",
    img: sampel2,
  },
  {
    name: "Pendorong Terjadinya Globalisasi   ",
    role: "Pendorong Terjadinya Globalisasi",
    company: "IDN.News",
    img: sampel3,
  },
  {
    name: "Dialus Andari",
    role: "UI/UX Designer",
    company: "Liputan6.com",
    img: sampel4,
  },
  {
    name: "Hutami Septiana Raswaty",
    role: "Digital Product Manager",
    company: "Daily Social",
    img: sampel5,
  },
];
...
function SliderPelatihan() {
  ...
  const getListKKAktif = async () => {
    ...
    try {
      const data = await UseFetch(
        API_LINK + "Klaim/GetProgramEksternalNotKlaim",
        currentFilterAktif
      );
      if (!data || data === "ERROR") {
  ...
  return (
    <div
      ...
      style={{ background: "transparent", height: "250px" }}
    >
      {isLoading ? (
        <p>Loading...</p>
      ) : isError ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="card-info">
                      ...
                      >
                        {decode(item["Nama Program"])}
                      </h4>
                      <p style={{ color: "#667085", textAlign: "justify" }}>
                        {" "}
                        {decode(item.Deskripsi).substring(0, 100)}
                      ...
                      >
                        <div className="">
                          ...
                          <h5 style={{ color: "#08549F", marginTop: "5px" }}>
      ...
      >
        {sliderData.map((item, index) => (
          <SwiperSlide key={index}>
            <div
              className=""
              style={{ border: "none", height: "80%", padding: "20px 0px" }}
            >
              <div
                className=""
                style={{
              ...
              >
                ...
                <div className="card-info">
                  ...
                  <p style={{ color: "#08549F" }} className="company">
                    {item.company}
                  </p>
                </div>
              </div>
    ...
    <>
            ...
            <div className="d-flex">
              ...
              >
                <h2 style={{ color: "#0A5EA8", fontWeight: "600" }}>
                  "Integritas, Handal, Tangguh: Berkolaborasi dan Berinovasi
                  Tanpa Batas!"
                </h2>
                <p
                  style={{ color: "#808080", width: "100%", marginTop: "20px" }}
                >
                  Mulai langkah barumu untuk mempelajari segala hal dengan mudah
                  dan cepat dengan P-Know System dari ASTRAtech
                </p>
      ...
      <AnimatedSection delay={0.2}>
        <section className="sec2">
          ...
          <p style={{ textAlign: "center", color: "white", fontSize: "14px" }}>
            Layanan pembelajaran yang lengkap tersedia di P-KNOW System untuk
            memudahkan proses pembelajaran anda di setiap saat kapan saja dan
            dimana saja.
          </p>
      ...
      <AnimatedSection delay={0.2}>
        <section className="sec3">
          <div className="d-flex" style={{ justifyContent: "space-between" }}>
            <div>
              <h4 style={{ color: "#0A5EA8", fontWeight: "600" }}>
                Kelas Pelatihan
              </h4>
              <p style={{ color: "#667085" }}>
                Mari bergabung di kelas ternama kami, ilmu yang diberikan pasti
        ...
        <section className="sec4">
          <div>
            ...
            >
              ...
              sekaligus kontribusi sosial mencerdaskan Bangsa. ASTRAtech
              memiliki banyak program studi yang memenuhi kebutuhan industri
              untuk melatih peserta didik dalam lingkungan kerja.
            </p>
      ...
      <AnimatedSection>
        <section className="sec2" style={{ height: "600px" }}>
          ...
          <p style={{ textAlign: "center", color: "white", fontSize: "14px" }}>
            P-KNOW telah menerbitkan banyak sekali artikel yang dapat menjadi
            informasi dan pengetahuan terkini untuk anda.
          </p>
