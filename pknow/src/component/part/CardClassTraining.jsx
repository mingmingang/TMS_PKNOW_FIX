            ...
            <div className="d-flex" style={{ width: "10%", marginTop:"15px" }}>
              <>
                <button
                    ...
                    aria-label={`Action for ${title}`}
                    onClick={handleLogin}
                    style={{border:"none", borderRadius:"10px", padding:"0px 10px", marginLeft:"-100px", marginTop:"-20px", background:"green"}}
                  >
      ...
      <div className="bg-white-kk">
        ...
        <div className="row">
            <div className="d-flex justify-content-between align-items-center mt-4">
              <h3 className="text-xl font-bold text-blue-600" style={{ fontSize: "17px", textAlign: "justify" }}>
                {decode(data.title)}
              </h3>
            </div>
        </div>
        ...
        <div className="pemilik ">
            ...
            <div className="userProdi">
            <i className="fas fa-tag" style={{fontSize:"18px", paddingLeft:"0px", color:"#4D4D4D"}}></i>  <p className="" style={{ marginLeft: "18px", width:"100%", fontSize:"15px", color:"#4D4D4D" }}>{data.harga && data.harga > 0 ? (
    <div
      className=""
      style={{
        color: "red",
    ...
    >
      Gratis
        ...
        <div className="deskripsi-container " style={{ alignItems: "center", width:"100%" }}>
              <p className="deskripsi" style={{ marginBottom: "10px", fontSize:"15px" }}>
              {decode(data.desc).substring(0, 100)}{/* Menampilkan 200 huruf pertama */}
