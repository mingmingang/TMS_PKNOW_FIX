...
const DashboardProfil = lazy(() => import("../page/master-mahasiswa/Index"));
const TentangKamiLogin = lazy(() =>
  import("../page/tentangkami/tentangkamiafterlogin/Root")
);
const TentangPKNOW= lazy(() =>
  import("../page/tentangkami/tentangkamibeforelogin/Root")
);
