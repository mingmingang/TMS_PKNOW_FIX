    ...
    const transformedMenu = [
      {
        ...
        head: "Dashboard",
        headkey: "dashboard",
        link: ROOT_LINK + "/dashboard/profil",
        sub: [],
        isHidden: true,
      },
       {
        head: "Dashboard",
        headkey: "dashboard",
        link: ROOT_LINK + "/dashboard/kelas_saya",
        sub: [],
        isHidden: true,
      },
      {
        head: "Dashboard",
        headkey: "dashboard",
        link: ROOT_LINK + "/dashboard/sertifikat",
        sub: [],
        isHidden: true,
      },
      {
        head: "Dashboard",
        headkey: "dashboard",
        link: ROOT_LINK + "/dashboard/pembelian",
        sub: [],
        isHidden: true,
      },
      {
        head: "Tentang PKNOW",
        headkey: "tentang_pknow",
        link: ROOT_LINK + "/tentang_pknow",
        sub: [],
        isHidden: true,
      },
      {
